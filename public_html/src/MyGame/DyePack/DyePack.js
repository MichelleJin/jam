...
function DyePack(spriteTexture, x, y) {
    ...
    this.mGhostPack = new SpriteRenderable(spriteTexture);
    this.mGhostPack.setColor([1, 1, 1, 0.1]);
    this.mGhostPack.getXform().setPosition(x, y);
    this.mGhostPack.getXform().setSize(this.kRefWidth, this.kRefHeight);
    this.mGhostPack.setElementPixelPositions(510, 595, 23, 153);
    GameObject.call(this, this.mGhostPack);
